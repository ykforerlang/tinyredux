...
const applyMiddleware = require('../lib/applyMiddleware').default
const bindActionCreators = require('../lib/bindActionCreators').default
const combineReducers = require('../lib/combineReducers').default
const combineReducersVariant = require('../lib/combineReducers').combineReducersVariant
